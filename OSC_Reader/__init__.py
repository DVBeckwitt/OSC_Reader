...
_OPTIONAL_EXPORTS: Dict[str, Tuple[str, str]] = {
    ...
    "DetectorCakeCalibrationStats": ("angle_space", "DetectorCakeCalibrationStats"),
    "DetectorCakeCoordinateStats": ("angle_space", "DetectorCakeCoordinateStats"),
    "DetectorCakeGeometry": ("angle_space", "DetectorCakeGeometry"),
    "DetectorCakeGeometryUncertainty": ("angle_space", "DetectorCakeGeometryUncertainty"),
    "DetectorCakeResult": ("angle_space", "DetectorCakeResult"),
    "DetectorCakeSubpixelErrorStats": ("angle_space", "DetectorCakeSubpixelErrorStats"),
